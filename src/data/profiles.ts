...
export const PROFILES: Record<ProfileId, ProfileConfig> = {
  ben: {
    ...
    knownGoodLooks: [
      ...
      'Taylor & Stitch lighter tan work jacket open over a white tee, KOTN brown corduroy trouser, Mephisto Rainbow brown suede moccasin hiker — the light jacket over the one dark garment, the trouser, with the shoe picking the trouser back up',
      'Mac Weldon sage/stone shirt open over a white tee, Toast brick/terracotta wide-leg trouser with a single cuff, Diadora Equipe Vela SW, brown belt — no dark piece anywhere; two mid tones held apart by the white tee and the cream sneaker',
      '45R indigo linen short-sleeve overshirt open over a white tee, G1 Goods sage/olive utility trouser cuffed once, Mephisto Rainbow brown suede moccasin hiker, brown belt — the darkest piece on top for once rather than at the bottom, over a mid trouser, with the white tee showing through the open front',
